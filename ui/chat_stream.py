...
def chatbot_interface(history, user_query, response_type=None):
    ...
    """
    if response_type:
        user_query = answer_style(user_query, response_type)
...
# NEW
def answer_style(user_input, response_type):
    if response_type == "Simple Language":
        user_input += " Please provide a clear and easy-to-understand explanation."
    elif response_type == "Technical":
        user_input += " Provide a detailed technical breakdown of the repair process."
    elif response_type == "Homer Simpson Language":
        user_input += " Provide an explanation of the repair process how Homer Simpson would say it."
    return user_input
